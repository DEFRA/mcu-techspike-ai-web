...
const schema = Joi.object({
  ...
  redirectUrl: Joi.string().default('http://localhost:3000/authenticate')
})
...
const config = {
  ...
  redirectUrl: process.env.REDIRECT_URL?.length > 0 ? process.env.REDIRECT_URL : 'http://localhost:3000/authenticate'
}
