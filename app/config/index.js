...
const schema = Joi.object({
  serviceName: Joi.string().default('MCU AI Techspike'),
  ...
  cache: {
    ...
    options: {
      ...
      partition: Joi.string().default('mcu-techspike-ai-web'),
  ...
  cookie: {
    cookieNameCookiePolicy: Joi.string().default('mcu_techspike_ai_web_cookie_policy'),
    cookieNameSession: Joi.string().default('mcu_techspike_ai_web_session'),
...
const config = {
  ...
  cookie: {
    cookieNameCookiePolicy: 'mcu_techspike_ai_web_cookie_policy',
    cookieNameSession: 'mcu_techspike_ai_web_session',
    isSameSite: 'Lax',
